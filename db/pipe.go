...
func (db Database) CreatePipe(pipe models.Pipe) (models.Pipe, error) {
...
func (db Database) GetPipe(pipeID, userID int64) (models.Pipe, error) {
	var pipe models.Pipe
...
func (db Database) GetPipeByName(pipeName string, userID int64) (models.Pipe, error) {
	var pipe models.Pipe
...
func (db Database) GetPipeAndResource(pipeID, userID int64) (models.PipeAndResource, error) {
...
func (db Database) GetPipesOnSteroid(userID int64) ([]models.Pipe, error) {
...
func (db Database) GetPipes(userID int64) ([]models.Pipe, error) {
	var pipes []models.Pipe
	query := `
...
func (db Database) UpdatePipe(userID int64, pipeID int64, updatedBody models.Pipe) (models.Pipe, error) {
	var pipe models.Pipe
...
func (db Database) UpdatePipeName(userID int64, pipeID int64, pipeName string) (models.Pipe, error) {
	var pipe models.Pipe
...
func (db Database) UpdatePipeCoverPhoto(userID int64, pipeID int64, pipeCp string) (models.Pipe, error) {
	var pipe models.Pipe
